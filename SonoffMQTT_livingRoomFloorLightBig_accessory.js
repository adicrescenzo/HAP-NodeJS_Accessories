...
var name = "Piantana Grande"; //accessory name
var sonoffUUID = "hap-nodejs:accessories:sonoff:floorlampbig"; //change this to your preferences
...
client.on('connect', function () {
  client.subscribe('stat/'+MQTT_NAME+'/POWER1', 2);
});
